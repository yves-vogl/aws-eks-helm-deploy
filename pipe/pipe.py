...
try:
    ...
    from .helm.error import HelmChartNotFoundError, HelmError
except ImportError:
    import schema
    from eks.client import EKSClientFactory
    from helm.client import HelmClient
...
class HelmPipe(Pipe):
    def run(self):
        ...
        eks_client = eks_client_factory.get_eks_client(
            region_name=region_name, role_arn=role_arn, role_session_name=session_name
        )
        ...
        sts_client = sts_client_factory.get_sts_client(region_name=region_name, role_arn=role_arn)
        ...
        try:
            ...
            helm_client.timeout = timeout

            # run client install command
